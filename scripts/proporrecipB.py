...
class ProporRamsey:
    ...
    def fileStatsCum(self,path,fileids):
        ...
        # stat classes
        C1 = MyClassStats2("ari+\nrecip",[],0,tit)
        C2 = MyClassStats2("cnt+\nrecip",[],0,tit)
        C3 = MyClassStats2("pro+\nrecip",[],0,tit)
        ...
        for idf in fileids:
            ...
            print "==> aristotelian + recip : " + `c1.count` + " matches"

            ####################################################################

            # class 2
            P2 = MyPatts2(counting).P
            N2 = MyPatts2(eachother).P
            #-------------------------------------------------------------------
            ...
            print "==> counting + recip : " + `c2.count` + " matches"

            ####################################################################

            # class 3
            P3 = MyPatts2(proportional).P
            N3 = MyPatts2(eachother).P
            #-------------------------------------------------------------------
            c3 = MyClass2(P3,N3,idf,0,0,"pro+\nrecip",my_tagger)
            print "---------------------------------------------------"
            print " Computing proportional + recip"
            print "---------------------------------------------------"
            c3.openFile2(path+"/"+idf,c3.pats,c3.patts)
